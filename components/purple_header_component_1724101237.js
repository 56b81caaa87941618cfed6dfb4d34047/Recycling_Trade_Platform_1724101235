...
Vue.component("purple_header_component_1724101237", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        ...
                        <li><a id="Trade-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Trade.html">Trade</a></li>
                        <li><a id="Recycling Guide-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Recycling Guide.html">Recycling Guide</a></li>
                        ...
                        <li><a id="Account-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Account.html">Account</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5 [background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box]">
                            ...
                            <li><a id="mobile-Trade-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Trade.html">Trade</a></li>
                            <li><a id="mobile-Recycling Guide-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Recycling Guide.html">Recycling Guide</a></li>
                            ...
                            <li><a id="mobile-Account-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Account.html">Account</a></li>
                        </ul>
                    </nav>
