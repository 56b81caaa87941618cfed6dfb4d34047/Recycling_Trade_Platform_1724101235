...
Vue.component("purple_hero_component_1724101237", {
    template: `
        ...
        <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
            ...
            <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative; z-index: 1">
                ...
                <div class="flex" id="sub-hero-text-container">
                    <p id="sub-hero-text" class="flex-1 text-lg mb-8 text-slate-300" data-aos="fade-down" data-aos-delay="200">Welcome to the ultimate marketplace for buying, selling, and trading recyclable materials. Connect with eco-conscious individuals and businesses to make a positive impact on the environment while earning from your waste.</p>
                </div>
